    ...
    fn from(ip_addr: &IpAddr) -> Condition {
        ...
        match ip_addr {
            IpAddr::V4(ip) => {
                ...
                let cond_mask = FWP_CONDITION_VALUE0___bindgen_ty_1 { v4AddrMask: &mut *ip_mask };
            ...
            IpAddr::V6(ip) => {
                ...
                condition.conditionValue.__bindgen_anon_1 =
                    FWP_CONDITION_VALUE0___bindgen_ty_1 { v6AddrMask: &mut *ip_mask };
            },
        }
